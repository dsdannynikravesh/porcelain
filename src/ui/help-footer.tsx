...
const KEYS: Array<[string, string, boolean?]> = [
  ...
  ["Enter", "commit (new line in description)", true],
  ["Tab", "summary ⇄ description (in commit box)"],
  ["^Enter", "commit from either field"],
  ["^G", "generate commit message with Copilot"],
  ["M", "amend"],
  ["p", "pull"],
  ["P", "push"],
  ...
  ["o", "open on GitHub"],
  ["z", "undo (reflog)"],
  ["g", "continue rebase/merge (after resolving conflicts)"],
  ["G", "abort rebase/merge"],
  ["?", "help", true],
  ["q", "quit", true],
];
